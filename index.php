...
define('MAIL_USERNAME' , 'phponline3@gmail.com');
define('MAIL_PASSWORD' , 'hgdzxpvwzvqmabzg');
define('MAIL_PORT' , 587);
define('SENDER_MAIL' , 'phponline3@gmail.com');
define('SENDER_NAME' , 'حامد زارع');
...
// $mail = new Auth();
// $mail->sendEmail('phponline3@gmail.com' , 'تستی' , '<p>این ایمیل تستی است</p>');
...
uri('admin/comment/status/{id}' , 'Admin\Comment' , 'changeStatus');
